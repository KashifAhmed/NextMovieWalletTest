...
function WavyBackground() {
  return (
    <div className="pointer-events-none absolute bottom-0 left-0 right-0 w-full overflow-hidden">
      <div className="relative h-28 w-full sm:h-32 md:h-36 lg:h-40">
        <svg
          className="absolute bottom-0 left-0 h-[111px] w-full"
